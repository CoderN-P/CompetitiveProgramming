...
if x[4] >= x[2] and x[3] <= x[1] and y[4] >= y[2] and y[3] <= y[1]:
    fout.write(str(0))
# Case 2
elif x[3] <= x[1] and y[3] <= y[1] < y[4] and x[4] >= x[2]:
    fout.write(str((x[2] - x[1]) * (y[2] - y[4])))
# Case 3
elif y[3] < y[2] <= y[4] and x[3] <= x[1] and x[4] >= x[2]:
    fout.write(str((x[2] - x[1]) * (y[3] - y[1])))
# Case 4
elif x[4] > x[1] >= x[3] and y[4] >= y[2] and y[3] <= y[1]:
    fout.write(str((x[2] - x[4]) * (y[2] - y[1])))
# Case 5
elif x[3] < x[2] <= x[4] and y[4] >= y[2] and y[3] <= x[1]:
